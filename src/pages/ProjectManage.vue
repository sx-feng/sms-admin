    ...
    >
      <el-form :model="form" :rules="rules" ref="projectFormRef" label-width="140px">
        ...
        <div class="step-container">
          <el-alert title="提取变量建议: 将 Token 提取为变量名 token，如果不需要登录可以不设置(该项为空)" type="success" :closable="false" style="margin-bottom:10px;" />
        ...
        <div class="step-container">
          <el-alert title="使用变量: {{token}} | 提取建议: 将手机号提取为 phone，将手机号唯一id提取为 id" type="warning" :closable="false" style="margin-bottom:10px;" />
        ...
        <div class="step-container">
          <el-alert title="使用变量: {{token}}, {{phone}}或者{{ id }} | 验证码提取为code" type="error" :closable="false" style="margin-bottom:10px;" />
...
const formConfig = computed(() => [
  ...
  },
  {
    title: '其他设置',
    fields: [
       { modelKey: 'enableFilter', label: '启用筛选', component: 'el-switch' },
